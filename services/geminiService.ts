...
import { Scope, TransactionResult, OCRResult, QuoteItem, QuoteResult, RFQResult, ServiceItem, ServiceCategory, ClientItem } from "../types";
...
export const generateQuote = async (
  ...
  const currency = getCurrency();
  const model = 'gemini-3-pro-preview'; // Force Pro for math reasoning
